...
export class MasterAIService {
  ...
  getAIs() {
    return this.http.get(`${systemSettings.serverURL}/getAINoletterfilter`);
  }
  addAI(AI) {
    console.log("added", {
      name: AI.AI_Name,
    ...
    return this.http
      .post(`${systemSettings.serverURL}/addAI`, {
        name: AI.AI_Name,
        atc_code: AI.AI_ATC_Code.filter(element => element != ""),
        category_Ids: AI.pharamaceutical.map(
          element => element.Pharmaceutical_Category_Code
  ...
  updateAI(updatedAI) {
    ...
    this.http
      .post(`${systemSettings.serverURL}/editAI`, {
        name: updatedAI.AI_Name,
        row_id: updatedAI.AI_Code,
        code: updatedAI.AI_Code,
        status: updatedAI.AI_Status,
  ...
  getAIMasterFieldStructure() {
    return this.http.get(
      `${systemSettings.serverURL}/getAIMasterFieldStructure`
    );
  }
  getPharmacologicalCategories() {
    return this.http.get(
      `${systemSettings.serverURL}/getPharmaceuticalCategory`
    );
  }
}
